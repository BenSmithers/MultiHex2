...
from MultiHex2.core.coordinates import screen_to_hex, hex_to_screen, get_adjacent_vertices
from MultiHex2.core.core import Path, get_nearest_vertex
from MultiHex2.widgets.widgets import PathWidget
...
class PathSelector(Basic_Tool):
    ...
    def get_next_steps(self, event:QGraphicsSceneEvent, from_end:bool)->list:
        ...
        if self._vertex_mode:
            ...
            return self.parent.get_route_a_star(start, end_id, OverlandRouteType.land)
